...
```{r}
subset(ganancias, select = c("id","genres", "revenue"))
```
...
subset(actores, select = c("id", "revenue", "actorsAmount", "releaseDate"))
```
...
subset(popularidad, select = c("id", "popularity", "castWomenAmount", "castMenAmount"))
```
